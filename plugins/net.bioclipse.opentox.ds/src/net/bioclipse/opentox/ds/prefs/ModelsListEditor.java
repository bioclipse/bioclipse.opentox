 ...
 * </p>
 */
public abstract class ModelsListEditor extends FieldEditor {
     ...
     */
    protected ModelsListEditor(String name, String labelText, Composite parent) {
        init(name, labelText);
    ...
    private String[] selectNewModels() {
